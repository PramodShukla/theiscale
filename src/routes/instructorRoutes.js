...
router.post("/add-instructor",authMiddleware,adminMiddleware, addInstructor);
router.get("/get-all-instructors", authMiddleware, adminMiddleware, getAllInstructors);
router.put("/update-instructor/:id", authMiddleware, adminMiddleware, updateInstructor);
